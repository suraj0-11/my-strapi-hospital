...
export interface ApiDispensaryDispensary extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::dispensary.dispensary'
    > &
      Schema.Attribute.Private;
    medicines: Schema.Attribute.JSON;
...
export interface ApiHospitalHospital extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dispensaries: Schema.Attribute.Relation<
      'oneToMany',
      'api::dispensary.dispensary'
    >;
    doctors: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    hospital_id: Schema.Attribute.UID<'Hospital_name'>;
    Hospital_name: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::dispensary.dispensary': ApiDispensaryDispensary;
